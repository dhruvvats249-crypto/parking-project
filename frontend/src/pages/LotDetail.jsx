...
import { Skeleton, SkeletonSlotGrid, SkeletonMap, SkeletonDirections, SkeletonBookingForm } from "../components/Skeleton";
    ...
    return (
      <div className="lot-detail">
        <div className="lot-detail-header">
          <Skeleton className="skeleton-text" style={{ width: "40%", height: "2rem" }} />
          <Skeleton className="skeleton-text" style={{ width: "60%", height: "1rem", marginTop: 8 }} />
        </div>
        <div className="detail-grid">
          <div>
            ...
            <div className="panel">
              <SkeletonSlotGrid rows={4} cols={5} />
            </div>
          </div>
          <div>
            <SkeletonBookingForm />
